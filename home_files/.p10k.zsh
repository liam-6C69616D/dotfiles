# Generated by Powerlevel10k configuration wizard on 2026-04-28 at 20:41 BST.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND="#5da276"
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND="#5da276"
  ...
  typeset -g POWERLEVEL9K_TIMEWARRIOR_BACKGROUND="#5da276"
  ...
  typeset -g POWERLEVEL9K_VIRTUALENV_BACKGROUND="#5da276"
  ...
  typeset -g POWERLEVEL9K_PUBLIC_IP_BACKGROUND="#ffffff"
  # Custom icon.
  ...
  ###########[ ip: ip address and bandwidth usage for a specified network interface ]###########
  # IP color.
  typeset -g POWERLEVEL9K_IP_BACKGROUND="#5da276"
